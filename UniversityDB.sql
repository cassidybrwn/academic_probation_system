...
(4, 2024, '1', 2, 4.0),  -- Bob, Data Structures, 2024, Semester 2 (passed)
(1, 2024, '2', 2, 2.5),  -- Bob, Calculus I, 2024, Semester 2 (redo passed)
(1, 2024, '1', 3, 2.0),  -- David, Calculus I, Semester 1 (passed)
(2, 2024, '1', 3, 1.5),  -- David, Physics I, Semester 1 (failed)
(2, 2024, '2', 3, 2.1),  -- David, Physics I, Semester 1 (redo passed)
(3, 2024, '2', 3, 2.2),  -- David, Intro to Programming, Semester 2 (passed)
...
(1, 2024, '1', 5, 1.3),  -- Tyrone, Calculus I, Semester 1 (failed)
(2, 2024, '1', 5, 2.2),  -- Tyrone, Physics I, Semester 1 (passed)
(4, 2024, '1', 5, 2.1),  -- Tyrone, Data Structures, Semester 1 (passed)
(1, 2024, '2', 5, 2.0);  -- Tyrone, Calculus I, Semester 2 (passed reattempt)
